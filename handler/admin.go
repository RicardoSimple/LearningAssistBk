...
var fullRoutes = []RouteInfo{
	{
		...
		Children: []RouteInfo{
			...
			},
			{
				...
				Meta:      MetaInfo{Title: "用户管理", Icon: "dashboard", Affix: true, Roles: []string{"admin"}},
			},
			{
				Path:      "course",
				Name:      "课程管理",
				Component: "views/course/index",
				Meta:      MetaInfo{Title: "课程管理", Icon: "dashboard", Affix: true, Roles: []string{"admin", "teacher"}},
			},
			{
				Path:      "classes",
				Name:      "班级管理",
				Component: "views/classes/index",
				Meta:      MetaInfo{Title: "班级管理", Icon: "dashboard", Affix: true, Roles: []string{"admin"}},
			},
			{
				Path:      "assignment",
				Name:      "作业管理",
